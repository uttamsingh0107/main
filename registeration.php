  ...
  <!-- Navigation & Intro -->
    <header>
      ...
      <nav class="navbar navbar-expand-lg navbar-dark fixed-top scrolling-navbar">
          <div class="container">
            <a class="navbar-brand" href="index.php">NITR Utsav</a>
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                <ul class="navbar-nav ml-auto smooth-scroll">
                  <li class="nav-item">
                      <a class="nav-link" href="registeration.php">Campus Ambassador</a>
                  </li>
                </ul>
            </div>
          </div>
    ...
    <h5 class="card-header indigo white-text text-center py-4">
      ...
      <?php include('validate.php'); ?>
        ...
        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" id="myForm" name="myForm">
            <div class="md-form">
                <input type="text" id="name" name="name" class="form-control form-input" style="align-content: center;" placeholder="Name" value="<?php echo $name ?>">
                <span class="error"><?php echo $nameErr; ?></span>
            </div>
            <div class="md-form">
                <input type="email" id="email" name="email" class="form-control form-input" placeholder="Email" value="<?php echo $email ?>">
                <span class="error"><?php echo $emailErr; ?></span>
            </div>
            <div class="md-form">
                <input type="text" id="contact" name="contact" class="form-control form-input" placeholder="Contact No." value="<?php echo $contact ?>">
                <span class="error"><?php echo $contactErr; ?></span>
            </div>
            <div class="md-form">
                <input type="text" id="college" name="college" class="form-control form-input" placeholder="College" value="<?php echo $college ?>">
                <span class="error"><?php echo $collegeErr; ?></span>
            </div>
            <div class="md-form">
                <input type="text" id="link" name="link" class="form-control form-input" placeholder="FB Link" value="<?php echo $link ?>">
